...
abstract class $UpdateUserRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String? email, String? passwordHash});
}
...
class _$_UpdateUserRequest implements _UpdateUserRequest {
  _$_UpdateUserRequest(this.id, {this.email, this.passwordHash});
  ...
  @override
  String toString() {
    return 'UpdateUserRequest(id: $id, email: $email, passwordHash: $passwordHash)';
  }
...
abstract class _UpdateUserRequest implements UpdateUserRequest {
  factory _UpdateUserRequest(final int id,
      {final String? email, final String? passwordHash}) = _$_UpdateUserRequest;
